...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">seller dashbord</span>
        </a>
              ...
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Create</span>
					...
					<li class="sidebar-item {{ request()->routeIs('vendor.store.store') ? 'active' : '' }}" >
              ...
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Create</span>
					...
					<li class="sidebar-item {{ request()->routeIs('vendor.product.store') ? 'active' : '' }}" >
